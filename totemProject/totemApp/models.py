...
class Vertebrates(models.Model):
    ...
    sources = models.CharField(max_length = 4000, unique = True)
    ...
    def __str__(self):
        ...
        return f'{self.classification} , {self.animal} , {self.country} - {self.country.continent} , {self.meaning} || {keywords} || {self.sources}'
